...
<figure style="text-align: center; margin: 2rem 0;">
  <img 
    src="/assets/images/projects/plumbing/plumbing-good.jpeg" 
    alt="In-game perspective during active play of the Plumbing Game" 
    loading="eager" 
    decoding="sync" 
  ...
  <figcaption style="margin-top: 1rem; font-size: 1rem; color: #161616;">
    In-game perspective during active play of the Plumbing Game
  </figcaption>
</figure>
...
<figure style="text-align: center; margin: 2rem 0;">
  <img 
    src="/assets/images/projects/plumbing/plumbing-bad.jpeg" 
    alt="Final pipe system's unfortunate state after just a few hours of play" 
    loading="eager" 
    decoding="sync" 
    style="border-radius: 0.5rem; max-width: 600px; width: 100%; height: auto;"
  >
  <figcaption style="margin-top: 1rem; font-size: 1rem; color: #161616;">
    The game's unfortunate state after just a few hours of play. Observe the missing screws, scattered hot glue strands, etc.
  </figcaption>
</figure>