...
export const siteName = 'Jeremy Pogue';
...
export const author = {
  name: 'Jeremy Pogue', // i.e. Lene Saile - page / blog author's name. Must be set.
  avatar: '/icon-512x512.png', // path to the author's avatar. In this case just using a favicon.
  email: 'jeremypogue2@gmail.com', // i.e. hola@lenesaile.com - email of the author
...
export const creator = {
  name: 'Jeremy Pogue', // i.e. Lene Saile - creator's (developer) name.
  email: 'jeremypogue2@gmail.com',
  website: 'https://www.lenesaile.com',
  social: 'https://front-end.social/@lene'
};
export const pathToSvgLogo = 'src/assets/svg/misc/logo-light.svg'; // used for favicon generation
export const themeColor = '#233a52'; // used in manifest, for example primary color value
